package au.com.ontheboat.api.security;
...
public class JwtUtils {
    ...
    @Value("${au.com.ontheboat.api.security.jwtSecret}")
    private String jwtSecret;

    @Value("${au.com.ontheboat.api.security.jwtExpirationMs}")
    private int jwtExpirationMs;

    @Value("${au.com.ontheboat.api.security.jwtCookieName}")
